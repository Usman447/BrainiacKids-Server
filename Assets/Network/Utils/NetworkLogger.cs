...
namespace Network.Utils
{
    ...
    public class NetworkLogger
    {
        ...
        /// <summary>Initializes <see cref="NetworkLogger"/> with all log types enabled.</summary>
        ...
        /// <summary>Initializes <see cref="NetworkLogger"/> with the supplied log methods.</summary>
        ...
        public static void Initialize(LogMethod debugMethod, LogMethod infoMethod, LogMethod warningMethod, LogMethod errorMethod, bool includeTimestamps, string timestampFormat = "HH:mm:ss")
        {
            ...
            NetworkLogger.includeTimestamps = includeTimestamps;
            NetworkLogger.timestampFormat = timestampFormat;
        }
        ...
        /// <summary>Dubug a message.</summary>
        /// <param name="message">The message to log.</param>
        public static void Log(object message)
        {
            if (logMethods.TryGetValue(LogType.Debug, out LogMethod logMethod))
            {
                if (includeTimestamps)
                    logMethod($"[{GetTimestamp(DateTime.Now)}]: {message}");
                else
        ...
        /// <summary>Log Warning a message.</summary>
        /// <param name="message">The message to log.</param>
        public static void LogWarning(object message)
        {
            if (logMethods.TryGetValue(LogType.Warning, out LogMethod logMethod))
            {
                if (includeTimestamps)
                    logMethod($"[{GetTimestamp(DateTime.Now)}]: {message}");
                else
        ...
        /// <summary>Log wrror a message.</summary>
        /// <param name="message">The message to log.</param>
        public static void LogError(object message)
        {
            if (logMethods.TryGetValue(LogType.Error, out LogMethod logMethod))
            {
                if (includeTimestamps)
                    logMethod($"[{GetTimestamp(DateTime.Now)}]: {message}");
                else
