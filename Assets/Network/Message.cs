...
namespace Network
{
    ...
    public class Message
    {
        ...
        public static int MaxSize { get; private set; } = MaxHeaderSize + 4091;
        ...
        public static int MaxPayloadSize
        {
            ...
            set
            {
                if (Peer.ActiveCount > 0)
                    NetworkLogger.Log(LogType.Error, $"Changing the max message size is not allowed while a {nameof(Server)} or {nameof(Client)} is running!");
                else
                {
                    if (value < 0)
                    {
                        NetworkLogger.Log(LogType.Error, $"The max payload size cannot be negative! Setting it to 0 instead of the given value ({value}).");
        ...
        public byte GetByte()
        {
            if (UnreadLength < 1)
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(ByteName));
                return 0;
            }
        ...
        public sbyte GetSByte()
        {
            if (UnreadLength < 1)
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(SByteName));
                return 0;
            }
        ...
        private void ReadBytes(int amount, byte[] intoArray, int startIndex = 0)
        {
            ...
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(intoArray.Length, ByteName));
                amount = UnreadLength;
            }
        ...
        private void ReadSBytes(int amount, sbyte[] intoArray, int startIndex = 0)
        {
            if (UnreadLength < amount)
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(intoArray.Length, SByteName));
                amount = UnreadLength;
            }
        ...
        public bool GetBool()
        {
            ...
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(BoolName, "false"));
                return false;
            }
        ...
        public bool[] GetBools(int amount)
        {
            ...
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(array.Length, BoolName));
        ...
        public void GetBools(int amount, bool[] intoArray, int startIndex = 0)
        {
            ...
            int byteAmount = amount / 8 + (amount % 8 == 0 ? 0 : 1);
            if (UnreadLength < byteAmount)
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(intoArray.Length, BoolName));
        ...
        public short GetShort()
        {
            ...
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(ShortName));
                return 0;
            }
        ...
        public ushort GetUShort()
        {
            ...
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(UShortName));
                return 0;
            }
        ...
        private void ReadShorts(int amount, short[] intoArray, int startIndex = 0)
        {
            ...
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(intoArray.Length, ShortName));
        ...
        private void ReadUShorts(int amount, ushort[] intoArray, int startIndex = 0)
        {
            ...
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(intoArray.Length, UShortName));
                amount = UnreadLength / sizeof(short);
            }
        ...
        public int GetInt()
        {
            ...
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(IntName));
                return 0;
            }
        ...
        public uint GetUInt()
        {
            ...
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(UIntName));
                return 0;
            }
        ...
        private void ReadInts(int amount, int[] intoArray, int startIndex = 0)
        {
            ...
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(intoArray.Length, IntName));
        ...
        private void ReadUInts(int amount, uint[] intoArray, int startIndex = 0)
        {
            ...
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(intoArray.Length, UIntName));
        ...
        public long GetLong()
        {
            ...
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(LongName));
                return 0;
            }
        ...
        public ulong GetULong()
        {
            ...
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(ULongName));
                return 0;
            }
        ...
        private void ReadLongs(int amount, long[] intoArray, int startIndex = 0)
        {
            ...
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(intoArray.Length, LongName));
        ...
        private void ReadULongs(int amount, ulong[] intoArray, int startIndex = 0)
        {
            ...
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(intoArray.Length, ULongName));
        ...
        public float GetFloat()
        {
            ...
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(FloatName));
                return 0;
            }
        ...
        private void ReadFloats(int amount, float[] intoArray, int startIndex = 0)
        {
            ...
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(intoArray.Length, FloatName));
        ...
        public double GetDouble()
        {
            ...
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(DoubleName));
                return 0;
            }
        ...
        private void ReadDoubles(int amount, double[] intoArray, int startIndex = 0)
        {
            ...
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(intoArray.Length, DoubleName));
        ...
        public string GetString()
        {
            ...
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(StringName, "shortened string"));
                length = UnreadLength;
            }
        ...
        private int GetArrayLength()
        {
            if (UnreadLength < 1)
            {
                NetworkLogger.Log(LogType.Error, NotEnoughBytesError(ArrayLengthName));
                return 0;
            }
